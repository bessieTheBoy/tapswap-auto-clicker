...
class ObjectRenderer:
    ...
    def load_wall_textures(self):
        if self.game.admin.die:
            return {
            1: self.get_texture("resources/textures/5.png"),
            2: self.get_texture("resources/textures/4.png"),
            3: self.get_texture("resources/textures/3.png"),
            4: self.get_texture("resources/textures/2.png"),
